...
namespace Juno.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult PostLogin(string userName, string password, string returnUrl = "/")
        {
            ...
            //if (ActiveDirectoryAccessVerifier.VerifyActiveDirectoryPassword(userName, password, global::Juno.Properties.Settings.Default.ActiveDirectoryDomain))
            //{
            //    FormsAuthentication.SetAuthCookie(userName.ToLower(), true);
            //    AuthenticateThisRequest();
